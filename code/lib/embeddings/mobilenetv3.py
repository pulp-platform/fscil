...
# Inspired by: https://github.com/ShowLo/MobileNetV3/blob/master/mobileNetV3.py
...
class MobileNetV3(nn.Module):
    ...
    '''
    def __init__(self, mode='small', num_classes=1000, input_size=224, width_multiplier=1.0, dropout=0.2, BN_momentum=0.1, zero_gamma=False):
        '''
        ...
        mode = mode.lower()
        assert mode in ['large', 'small', 'small_8x8']
        s = 2
        ...
        self.n_interm_feat = last_channels_num
