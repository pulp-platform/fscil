...
from .NoisyBatchNorm import NoisyBatchNorm2d

# batchnorm = NoisyBatchNorm2d
...
class ConvNormActivation(torch.nn.Sequential):
    def __init__(
        ...
        groups: int = 1,
        norm_layer: Optional[Callable[..., torch.nn.Module]] = batchnorm,
...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        self.conv_embedding = nn.Sequential(*features)
        ...
        self.n_interm_feat = self.last_channel
